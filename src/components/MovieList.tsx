...
const MovieLoader = () => (
  <>
    ...
    >
      <ContentLoader
        uniqueKey="listLoaderDesktop"
        width={650}
        height={150}
        backgroundColor="hsla(220, 10%, 50%, 0.2)"
        foregroundColor="hsla(220, 10%, 50%, 0.1)"
      >
        <path
    ...
    >
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M8.69565 0C3.89325 0 0 3.89325 0 8.69565V91.3043C0 96.1068 3.89325 100 8.69565 100H91.3043C96.1068 100 100 96.1068 100 91.3043V8.69565C100 3.89325 96.1068 0 91.3043 0H8.69565ZM19.9426 47.3673C19.324 44.6913 18.728 42.1145 18.2065 39.8666L15.0001 26.1538H18.146C24.9828 26.1538 30.6094 26.9223 31.0934 27.8681C31.396 28.3999 32.364 32.6557 33.2713 37.3843C34.1184 42.0538 35.026 46.0728 35.147 46.2503C35.8125 46.8413 37.0831 44.3588 37.7487 41.0488C38.1117 39.2164 39.2005 35.67 40.1081 33.2466L41.8022 28.8136L56.504 28.4591L58.6821 35.4338C61.344 43.7086 63.7037 48.6737 64.4295 47.3734C64.732 46.9005 65.6396 43.2357 66.5472 39.1575C68.6043 29.4049 69.2696 27.3952 70.4192 27.0996C72.0528 26.6267 84.9999 25.9766 84.9999 26.3314C84.9999 26.5678 83.7901 30.7644 82.338 35.7292C79.0105 46.8413 76.7114 55.8254 73.7469 69.4792L71.4478 80.0001L57.5325 79.6456L55.8989 75.2126C55.0519 72.7892 53.1765 67.1148 51.7244 62.6818L49.0622 54.5251L46.5213 62.0908C45.1297 66.2282 43.5565 71.0749 43.0123 72.9073C42.1047 76.0992 41.9232 76.2764 39.8055 76.631C36.9621 77.0447 29.4598 77.1039 27.8265 76.631C26.7979 76.3945 26.2533 74.6805 24.0147 64.987C22.9943 60.5832 21.4058 53.6974 19.9426 47.3673Z"
          fill="#FAF9F9"
        />
      </ContentLoader>
    </Box>
